  ...
  config = function()
    ...
    require('dashboard').setup({
      ...
      config = {
        ...
        center = {
          { icon = icons.ui.NewFile .. ' ',  desc = 'New File               ',     key = 'Space + te', action = 'Neotree reveal toggle' },
          { icon = icons.ui.FindFile .. ' ', desc = 'Search Files               ', key = 'Space + sf', action = 'Telescope find_files' },
          { icon = icons.ui.History .. ' ',  desc = 'Search History            ',  key = 'Space + sh', action = 'Telescope oldfiles' },
